...
#### set the following properties inside you properties file: datasource.url datasource.username datasource.password (datasource.url must contain full connection path plus db name)
